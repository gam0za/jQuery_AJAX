...
* $(selector).html(value); 와 $(selector).text(value);

* $(selector).html(function(index,html){}); 와 $(selector).text(function(index,text){});
...
* $('h1태그 Hello World h1태그').appendTo('body');

* $('<h1태그></h1태그>').attr('width',100).appendTo('body');

* $('<h1태그></h1태그>',{width:100,  height:50}).appendTo('body');
